...
const dayNumber = Math.floor((new Date() - dayStart) / 86400000);
let currentIndex = dayNumber % QUOTES.length;
...
function fitToScreen() {
  ...
  requestAnimationFrame(() => {
    ...
    if (used > available) {
      ...
      quoteCard.style.transformOrigin = window.innerWidth < 680 ? "left bottom" : "left center";
    }
  });
}
